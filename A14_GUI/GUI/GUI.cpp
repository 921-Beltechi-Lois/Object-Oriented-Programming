...
GUI::GUI(Service &service, UserService &userService, EventValidator &validator, Repository &repository1)
    ...
    this->tableButton=new QPushButton(this);
...
//    ListViewWidget* listW = new ListViewWidget{model};
    ...
    this->table = new TableViewWidget(this->userService);
...
void GUI::initGUI() {
    ...
    this->tableButton->setText("Table View mode");
    layout->addWidget(this->tableButton);
...
void GUI::connectSignalsAndSlots() {
    ...
    QObject::connect(this->tableButton, &QPushButton::clicked, this, &GUI::showTable);

}

void GUI::showTable() {
    this->table= new TableViewWidget(userService);
    this->table->show();
}
        ...
        try {
           // this->validator.validateTitle(title);
            ...
            if (!this->filtered)
                ...
                //this->table->ui->TableVIEW->addItem
