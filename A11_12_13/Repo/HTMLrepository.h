...
#ifndef A8_9_911_BELTECHI_LOIS_HTMLREPOSITORY_H
#define A8_9_911_BELTECHI_LOIS_HTMLREPOSITORY_H

#include "UserRepository.h"

class HTMLRepo: public UserRepository {
public:
    HTMLRepo(const std::vector<Event>& UserList, const std::string& userFilename);
...
#endif //A8_9_911_BELTECHI_LOIS_HTMLREPOSITORY_H
